...
import { getEarning, addEarning, deleteEarning, updateEarning } from '../../store/thunk/earning.thunk';
...
const earningSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(addEarning.fulfilled, (state) => {
      state.isLoading = false;
      // state.data.earnings = payload;
    });
    ...
    builder
      ...
      .addCase(deleteEarning.fulfilled, (state) => {
        state.isLoading = false;
        // state.data.earnings = payload;
      })
    ...
    builder
      ...
      .addCase(updateEarning.fulfilled, (state) => {
        state.isLoading = false;
        // state.data.earnings = payload;
      })

...
import { addPayRoll, deletePayRoll, getPayRoll, updatePayRoll } from '../../store/thunk/payroll.thunk';
...
const payRollSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(addPayRoll.fulfilled, (state) => {
      state.isLoading = false;
      // state.data.payrolls = payload;
    });
    ...
    builder
      ...
      .addCase(deletePayRoll.fulfilled, (state) => {
        state.isLoading = false;
        // state.data.payrolls = payload;
      })
    ...
    builder
      ...
      .addCase(updatePayRoll.fulfilled, (state) => {
        state.isLoading = false;
